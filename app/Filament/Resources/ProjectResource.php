        ...
        return $table
            ...
            ->actions([
                ...
                ActionGroup::make([
                    ...
                    Tables\Actions\Action::make('budget_division')->label('Particulars')->icon('heroicon-m-table-cells')->url(fn (Model $record): string => ProjectResource::getUrl('project-table-division', ['record' => $record])),
                    ...
                    Tables\Actions\Action::make('year_quarter_budget')->label('Quarter Expenses')->icon('heroicon-m-banknotes')->url(fn (Model $record): string => ProjectResource::getUrl('manage-quarter-year', ['record' => $record])),
